...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "paulthoms.9@gmail.com", ZIPCode = "12345" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("paulthoms.96@gmail.com", "Forms"), null);
